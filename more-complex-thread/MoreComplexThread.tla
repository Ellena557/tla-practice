...
\* BEGIN TRANSLATION (chksum(pcal) = "3f9b0ef1" /\ chksum(tla) = "8870f65f")
...
T1_step1 == /\ pc[0] = "T1_step1"
            /\ pc' = [pc EXCEPT ![0] = "T1_step2"]
            /\ UNCHANGED << mutex1, mutex2, mutex3, flag, holder1, holder2, 
                            holder3 >>

T1_step2 == /\ pc[0] = "T1_step2"
            /\ IF (flag)
                  THEN /\ pc' = [pc EXCEPT ![0] = "T1_step3"]
                  ELSE /\ pc' = [pc EXCEPT ![0] = "T1_step1"]
            /\ UNCHANGED << mutex1, mutex2, mutex3, flag, holder1, holder2, 
                            holder3 >>

T1_step3 == /\ pc[0] = "T1_step3"
            /\ ((holder2 = 1) \/ (mutex2 = 0))
            /\ mutex2' = mutex2 + 1
            /\ holder2' = 1
            /\ pc' = [pc EXCEPT ![0] = "T1_step4"]
            /\ UNCHANGED << mutex1, mutex3, flag, holder1, holder3 >>

T1_step4 == /\ pc[0] = "T1_step4"
            /\ ((holder1 = 1) \/ (mutex1 = 0))
            /\ mutex1' = mutex1 + 1
            /\ holder1' = 1
            /\ pc' = [pc EXCEPT ![0] = "T1_step5"]
            /\ UNCHANGED << mutex2, mutex3, flag, holder2, holder3 >>

T1_step5 == /\ pc[0] = "T1_step5"
            /\ flag' = FALSE
            /\ pc' = [pc EXCEPT ![0] = "T1_step6"]
            /\ UNCHANGED << mutex1, mutex2, mutex3, holder1, holder2, holder3 >>

T1_step6 == /\ pc[0] = "T1_step6"
            /\ TRUE
            /\ pc' = [pc EXCEPT ![0] = "T1_step7"]
            /\ UNCHANGED << mutex1, mutex2, mutex3, flag, holder1, holder2, 
                            holder3 >>

T1_step7 == /\ pc[0] = "T1_step7"
            /\ mutex1' = mutex1 - 1
            /\ IF (mutex1' = 0)
                  THEN /\ holder1' = 2
                  ELSE /\ TRUE
                       /\ UNCHANGED holder1
            /\ pc' = [pc EXCEPT ![0] = "T1_step8"]
            /\ UNCHANGED << mutex2, mutex3, flag, holder2, holder3 >>

T1_step8 == /\ pc[0] = "T1_step8"
            /\ ((holder2 = 1) \/ (mutex2 = 0))
            /\ mutex2' = mutex2 + 1
            /\ holder2' = 1
            /\ pc' = [pc EXCEPT ![0] = "T1_step9"]
            /\ UNCHANGED << mutex1, mutex3, flag, holder1, holder3 >>

T1_step9 == /\ pc[0] = "T1_step9"
            /\ ((holder1 = 1) \/ (mutex1 = 0))
            /\ mutex1' = mutex1 + 1
            /\ holder1' = 1
            /\ pc' = [pc EXCEPT ![0] = "T1_step10"]
            /\ UNCHANGED << mutex2, mutex3, flag, holder2, holder3 >>

T1_step10 == /\ pc[0] = "T1_step10"
             /\ flag' = FALSE
             /\ pc' = [pc EXCEPT ![0] = "T1_step11"]
             /\ UNCHANGED << mutex1, mutex2, mutex3, holder1, holder2, holder3 >>

T1_step11 == /\ pc[0] = "T1_step11"
             /\ mutex1' = mutex1 - 1
             /\ IF (mutex1' = 0)
                   THEN /\ holder1' = 2
                   ELSE /\ TRUE
                        /\ UNCHANGED holder1
             /\ pc' = [pc EXCEPT ![0] = "T1_step1"]
             /\ UNCHANGED << mutex2, mutex3, flag, holder2, holder3 >>
...
\* Last modified Mon Apr 26 18:15:56 MSK 2021 by Elena
