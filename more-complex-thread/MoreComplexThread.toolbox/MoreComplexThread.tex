...
\fl{}\moduleLeftDash\cl{ {\MODULE} MoreComplexThread}\moduleRightDash\cl{}
\fl{}
\fl{ {\EXTENDS} Integers ,\, TLC ,\, Sequences}
\fl{}
\fl{ {\p@mmalgorithm} xp}
\fl{ {\p@variables}}
\fl{ mutex1}\al{6}{1}{ \.{=}}\al{6}{2}{ 0}\al{6}{3}{ {\p@semicolon}}
\fl{ mutex2}\al{7}{1}{ \.{=}}\al{7}{2}{ 0}\al{7}{3}{ {\p@semicolon}}
\fl{ mutex3}\al{8}{1}{ \.{=} 0}\al{8}{3}{ {\p@semicolon}}
\fl{ flag \.{=} {\FALSE} {\p@semicolon}}
\fl{ holder1}\al{10}{1}{ \.{=}}\al{10}{2}{ 2}\al{10}{3}{ {\p@semicolon}%
\@y{\@s{0}%
 who holds \ensuremath{mutex1} (\ensuremath{0 \.{-} Thread0}, \ensuremath{1
 \.{-} Thread1}, \ensuremath{2 \.{-}} no one)
}%
}
\fl{ holder2}\al{11}{1}{ \.{=}}\al{11}{2}{ 2}\al{11}{3}{ {\p@semicolon}}
\fl{ holder3}\al{12}{1}{ \.{=} 2}\al{12}{3}{ {\p@semicolon}}
\fl{}
\fl{ {\p@process} Thread0 \.{=} 0}
\fl{ {\p@begin}}
\fl{ T0\_step1\@s{.5}\textrm{:}\@s{3} {\p@while} ( {\TRUE} ) {\p@do}}
\fl{}
\fl{}
 \fl{ T0\_step2\@s{.5}\textrm{:}\@s{3}}\al{19}{1}{ {\p@if} ( ( holder1 \.{=} 0
 ) \.{\lor} ( mutex1 \.{=} 0 ) ) {\p@then}}
\fl{}
\fl{ mutex1 \.{:=} mutex1 \.{+} 1 {\p@semicolon}}
\fl{ holder1 \.{:=} 0 {\p@semicolon}}
\fl{}
\fl{}
 \fl{ T0\_step3\@s{.5}\textrm{:}\@s{3}}\al{25}{1}{ {\p@await} ( ( holder3
 \.{=} 0 ) \.{\lor} ( mutex3 \.{=} 0 ) ) {\p@semicolon}}
\fl{}\al{26}{0}{}
\fl{}\al{27}{0}{ holder3 \.{:=} 0 {\p@semicolon}}
\fl{}\al{28}{0}{ mutex3 \.{:=} mutex3 \.{+} 1 {\p@semicolon}}
\fl{}
\fl{}
 \fl{ T0\_step4\@s{.5}\textrm{:}\@s{3}}\al{31}{1}{ {\p@await} ( ( holder1
 \.{=} 0 ) \.{\lor} ( mutex1 \.{=} 0 ) ) {\p@semicolon}}
\fl{}\al{32}{0}{ mutex1 \.{:=} mutex1 \.{+} 1 {\p@semicolon}}
\fl{}\al{33}{0}{ holder1 \.{:=} 0 {\p@semicolon}}
\fl{}
\fl{}
\fl{ T0\_step5\@s{.5}\textrm{:}\@s{3} {\p@skip} {\p@semicolon}}
\fl{}
\fl{}
 \fl{ T0\_step6\@s{.5}\textrm{:}\@s{3}}\al{39}{1}{ mutex1 \.{:=} mutex1 \.{-}
 1 {\p@semicolon}}
\fl{}\al{40}{0}{ {\p@if} ( mutex1 \.{=} 0 ) {\p@then}}
\fl{ holder1 \.{:=} 2 {\p@semicolon}}
\fl{}\al{42}{0}{ {\p@end} {\p@if} {\p@semicolon}}
\fl{}
\fl{}
 \fl{ T0\_step7\@s{.5}\textrm{:}\@s{3}}\al{45}{1}{ {\p@await} ( ( holder2
 \.{=} 0 ) \.{\lor} ( mutex2 \.{=} 0 ) ) {\p@semicolon}}
\fl{}\al{46}{0}{ holder2 \.{:=} 0 {\p@semicolon}}
\fl{}\al{47}{0}{ mutex2 \.{:=} mutex2 \.{+} 1 {\p@semicolon}}
\fl{}
\fl{}
\fl{ T0\_step8\@s{.5}\textrm{:}\@s{3} flag \.{:=} {\FALSE} {\p@semicolon}}
\fl{}
\fl{}
 \fl{ T0\_step9\@s{.5}\textrm{:}\@s{3}}\al{53}{1}{ mutex2 \.{:=} mutex2 \.{-}
 1 {\p@semicolon}}
\fl{}\al{54}{0}{ {\p@if} ( mutex2 \.{=} 0 ) {\p@then}}
\fl{ holder2 \.{:=} 2 {\p@semicolon}}
\fl{}\al{56}{0}{ {\p@end} {\p@if} {\p@semicolon}}
\fl{}
\fl{}
 \fl{ T0\_step10\@s{.5}\textrm{:}\@s{3}}\al{59}{1}{ mutex3 \.{:=} mutex3 \.{-}
 1 {\p@semicolon}}
\fl{}\al{60}{0}{ {\p@if} ( mutex3 \.{=} 0 ) {\p@then}}
\fl{ holder3 \.{:=} 3 {\p@semicolon}}
\fl{}\al{62}{0}{ {\p@end} {\p@if} {\p@semicolon}}
\fl{}
\fl{ {\p@else}}
\fl{}
\fl{}
 \fl{ T0\_step11\@s{.5}\textrm{:}\@s{3}}\al{67}{1}{ {\p@await} ( ( holder2
 \.{=} 0 ) \.{\lor} ( mutex2 \.{=} 0 ) ) {\p@semicolon}}
\fl{}\al{68}{0}{ mutex2 \.{:=} mutex2 \.{+} 1 {\p@semicolon}}
\fl{}\al{69}{0}{ holder2 \.{:=} 0 {\p@semicolon}}
\fl{}
\fl{}
\fl{ T0\_step12\@s{.5}\textrm{:}\@s{3} flag \.{:=} {\TRUE} {\p@semicolon}}
\fl{}
\fl{}
 \fl{ T0\_step13\@s{.5}\textrm{:}\@s{3}}\al{75}{1}{ mutex2 \.{:=} mutex2 \.{-}
 1 {\p@semicolon}}
\fl{}\al{76}{0}{ {\p@if} ( mutex2 \.{=} 0 ) {\p@then}}
\fl{ holder2 \.{:=} 2 {\p@semicolon}}
\fl{}\al{78}{0}{ {\p@end} {\p@if} {\p@semicolon}}
\fl{}
\fl{ {\p@end} {\p@if} {\p@semicolon}}
\fl{ {\p@end} {\p@while}}\al{81}{2}{ {\p@semicolon}}
\fl{ {\p@end} {\p@process}}\al{82}{2}{ {\p@semicolon}}
\fl{}
\fl{}
\fl{ {\p@process} Thread1 \.{=} 1}
\fl{ {\p@begin}}
\fl{ T1\_step1\@s{.5}\textrm{:}\@s{3} {\p@while} ( {\TRUE} ) {\p@do}}
\fl{}
\fl{}
\fl{ T1\_step2\@s{.5}\textrm{:}\@s{3} {\p@if} ( flag ) {\p@then}}
\fl{}
\fl{}
 \fl{ T1\_step3\@s{.5}\textrm{:}\@s{3}}\al{93}{1}{ {\p@await} ( ( holder2
 \.{=} 1 ) \.{\lor} ( mutex2 \.{=} 0 ) ) {\p@semicolon}}
\fl{}\al{94}{0}{ mutex2 \.{:=} mutex2 \.{+} 1 {\p@semicolon}}
\fl{}\al{95}{0}{ holder2 \.{:=} 1 {\p@semicolon}}
\fl{}
\fl{}
 \fl{ T1\_step4\@s{.5}\textrm{:}\@s{3}}\al{98}{1}{ {\p@await} ( ( holder1
 \.{=} 1 ) \.{\lor} ( mutex1 \.{=} 0 ) ) {\p@semicolon}}
\fl{}\al{99}{0}{ mutex1 \.{:=} mutex1 \.{+} 1 {\p@semicolon}}
\fl{}\al{100}{0}{ holder1 \.{:=} 1 {\p@semicolon}}
\fl{}
\fl{}
\fl{ T1\_step5\@s{.5}\textrm{:}\@s{3} flag \.{:=} {\FALSE} {\p@semicolon}}
\fl{}
\fl{}
\fl{ T1\_step6\@s{.5}\textrm{:}\@s{3} {\p@skip} {\p@semicolon}}
\fl{}
\fl{}
 \fl{ T1\_step7\@s{.5}\textrm{:}\@s{3}}\al{109}{1}{ mutex1 \.{:=} mutex1 \.{-}
 1 {\p@semicolon}}
\fl{}\al{110}{0}{ {\p@if} ( mutex1 \.{=} 0 ) {\p@then}}
\fl{ holder1 \.{:=} 2 {\p@semicolon}}
\fl{}\al{112}{0}{ {\p@end} {\p@if} {\p@semicolon}}
\fl{}
\fl{}
 \fl{ T1\_step8\@s{.5}\textrm{:}\@s{3}}\al{115}{1}{ {\p@await} ( ( holder2
 \.{=} 1 ) \.{\lor} ( mutex2 \.{=} 0 ) ) {\p@semicolon}}
\fl{}\al{116}{0}{ mutex2 \.{:=} mutex2 \.{+} 1 {\p@semicolon}}
\fl{}\al{117}{0}{ holder2 \.{:=} 1 {\p@semicolon}}
\fl{}
\fl{ {\p@else}}
\fl{}
\fl{}
 \fl{ T1\_step9\@s{.5}\textrm{:}\@s{3}}\al{122}{1}{ {\p@await} ( ( holder1
 \.{=} 1 ) \.{\lor} ( mutex1 \.{=} 0 ) ) {\p@semicolon}}
\fl{}\al{123}{0}{ mutex1 \.{:=} mutex1 \.{+} 1 {\p@semicolon}}
\fl{}\al{124}{0}{ holder1 \.{:=} 1 {\p@semicolon}}
\fl{}
\fl{}
\fl{ T1\_step10\@s{.5}\textrm{:}\@s{3} flag \.{:=} {\FALSE} {\p@semicolon}}
\fl{}
\fl{}
\fl{}
 \fl{ T1\_step11\@s{.5}\textrm{:}\@s{3}}\al{131}{1}{ mutex1 \.{:=} mutex1
 \.{-} 1 {\p@semicolon}}
\fl{}\al{132}{0}{ {\p@if} ( mutex1 \.{=} 0 ) {\p@then}}
\fl{ holder1 \.{:=} 2 {\p@semicolon}}
\fl{}\al{134}{0}{ {\p@end} {\p@if} {\p@semicolon}}
\fl{}
\fl{ {\p@end} {\p@if} {\p@semicolon}}
\fl{ {\p@end} {\p@while}}\al{137}{2}{ {\p@semicolon}}
\fl{ {\p@end} {\p@process}}\al{138}{2}{ {\p@semicolon}}
\fl{}
\fl{}
